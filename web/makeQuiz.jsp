            ...
            <form action="MakeQuizController" method="POST">
                <table class="make-quiz">
                    ...
                    <tr>
                        ...
                        <td>
                            <textarea maxlength="50" class="textarea-question" name="question" required>${question}</textarea>
                        </td>
                    </tr>
                    ...
                    <c:forEach var="i" begin="0" end="3" step="1" >
                        <tr>
                            ...
                            <td>
                                <textarea  maxlength="50" class="textarea-option"  name="answer"  required>${answer[i]}</textarea>
                            </td>
                        </tr>
                    </c:forEach>
